...
//        }
    ...
    public static int sendPowerToConnections(@NotNull List<TileEntityWithCapabilities> machines, int availablePower, int drainPower) {
        int powerDrained = 0;

//        for (var machine : machines) {
//            var powerStorage = machine.getPowerStorage();
//            if (powerStorage == null) continue;
//            if (availablePower - powerDrained > 0) {
//                if (powerStorage.charge(Math.min(availablePower, drainPower), 6, true) > 0) {
